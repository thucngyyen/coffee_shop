...
AUTH0_DOMAIN = 'coffee-shop-thucngyyen.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'coffee_shop_menu'
    ...
    if rsa_key:
        try:
            ...
            raise AuthError({
                'code': 'invalid_claims',
                'description':
                    'Incorrent claims. Please, check the audience and issuer.'
            }, 401)
